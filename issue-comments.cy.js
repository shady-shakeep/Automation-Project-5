describe('Issue comments creating, editing and deleting', () => {
    ...
    it('Test case 1: Test combination, Comments functionality', () => {
        const comment = 'this is comment for test case 1, assignment 1';
        const EditedComment = 'edited comment for assignment 1';
        ...
        cy.get('[data-testid="modal:confirm"]').within(() => {
            ...
            .should('be.visible');
            cy.contains('button', 'Delete comment').first().click().should('not.exist');
            });
            getIssueDetailsModal().within(() => {
